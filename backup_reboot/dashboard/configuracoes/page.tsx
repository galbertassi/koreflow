            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                <div className="p-6 border border-emerald-500/30 rounded-2xl bg-emerald-500/5 relative overflow-hidden">
                  ...
                  <h3 className="text-lg font-bold text-foreground mb-2">Plano Atual: KORE FLOW Free</h3>
                  <p className="text-sm text-muted-foreground mb-6 max-w-md">Você está utilizando os recursos básicos. Faça o upgrade para desbloquear relatórios ilimitados e gestão completa de equipes.</p>
                  <a href="/vendas" className="inline-flex px-6 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl text-sm font-bold transition-colors shadow-lg shadow-emerald-500/20">
