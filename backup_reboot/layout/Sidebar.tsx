      ...
      <div className="p-3 border-t border-sidebar-border/50 space-y-1 relative" ref={profileMenuRef}>
            ...
            <div className="flex items-center gap-3 px-3 py-2 mb-2 border-b border-white/10 hover:bg-white/5 cursor-pointer rounded-lg transition-colors">
              ...
              <div className="flex-1 overflow-hidden flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs text-white/60 truncate leading-tight mt-0.5">Plus</p>
                </div>
                <ChevronLeft className="w-4 h-4 text-white/50 rotate-180" />
              </div>
            </div>

            <a href="/vendas" onClick={() => setIsProfileMenuOpen(false)} className="w-full flex items-center gap-3 px-3 py-2.5 text-sm font-medium hover:bg-white/10 rounded-lg transition-colors cursor-pointer text-white">
              <Sparkles className="w-4 h-4" /> Subir de plano
            </a>
        ...
        >
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <p className="text-[11px] text-muted-foreground truncate font-medium">Plus</p>
          </div>
