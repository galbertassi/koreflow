        ...
        >
          ...
          >
            <div className="space-y-8">
              ...
              <form id="auth-form" action={login} className="space-y-5">
                ...
                <div className="pt-2 flex flex-col items-center gap-4">
                  ...
                  <div className="flex w-full justify-between px-2">
                    <button formAction={signup} className="text-[13px] text-[#888888] hover:text-white transition-colors font-medium">
                      Criar conta
                    </button>
