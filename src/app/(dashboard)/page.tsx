...
export default function DashboardPage() {
  ...
  const nomeUsuario = configuracoes?.nome ? configuracoes.nome.split(" ")[0] : "Usu├írio";
        ...
        <div className="max-w-4xl mx-auto py-12 px-4 w-full">
          ...
          <div className="mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-xl">
              Planejamento, execu├º├úo e entregas centralizados em um ├║nico fluxo.
            </p>
          </div>

          {/* Checklist Inicial / Cria├º├Áes */}
          <DashboardActions />
        </div>
      )}
    </div>
