...
export default function VendasPremiumPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black overflow-x-clip font-sans">
      ...
      <section className="relative w-full bg-black overflow-hidden flex flex-col lg:block lg:min-h-screen pt-32 pb-0 lg:pt-0 lg:pb-0">
        ...
        <div
          className="relative w-full h-full mx-auto flex items-center z-0 order-2 lg:order-none mt-12 lg:mt-0 lg:absolute lg:inset-0"
          style={{
            // O segredo do "zoom perfeito" em telas menores:
            // Limitamos a largura máxima baseada na altura da tela (160vh).
            // Assim, em telas baixas (como notebooks), o bloco encolhe e centraliza (mx-auto),
            // simulando perfeitamente o efeito visual de "zoom 75%", sem cortar o topo/base.
            // Em telas gigantes (32"), 160vh é maior que 1920px, então ele trava em 1920px e fica perfeito.
            maxWidth: 'min(1920px, 160vh)',
        ...
        >
          ...
          */}
          <div className="relative w-full h-auto transform lg:scale-[0.90] xl:scale-100 lg:translate-x-4 xl:translate-x-8 2xl:translate-x-12 origin-center lg:origin-right transition-transform duration-1000">
            {/* Imagem de fundo nítida no centro e com máscara de fade nas laterais para fundir com o fundo preto */}
            <img
      ...
      <section id="plataforma" className="w-full py-32 bg-black border-t border-white/5 relative z-10">
      ...
      <section className="w-full bg-black py-32 overflow-hidden relative">
        {/* Glow de fundo */}
      ...
      <section className="w-full bg-black flex flex-col md:flex-row min-h-[70vh]">
      ...
      {/* 9. PLANOS (DARK) */}
      <section id="planos" className="w-full bg-black py-32 flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      <section className="w-full bg-black py-32 px-6 relative overflow-hidden">
      ...
      <footer className="w-full font-sans border-t border-white/5 flex flex-col">
        {/* TOP BAR */}
        <div className="w-full bg-black py-16 px-6 border-b border-white/5">
        ...
        <div className="w-full bg-black pt-20 pb-8 px-6 relative overflow-hidden">
          <div className="max-w-7xl mx-auto">
