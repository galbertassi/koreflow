...
export function DashboardCards() {
  ...
  const topCards = [
    ...
    { title: "Concluídas", value: entregues.toString(), icon: CheckCircle2, color: "text-emerald-500", bgColor: "bg-emerald-500/10", trendValue: atividadesTotais ? `${Math.round((entregues / atividadesTotais) * 100)}%` : "0%", trendText: "do total", trendUp: null, trendColor: "text-emerald-500" },
