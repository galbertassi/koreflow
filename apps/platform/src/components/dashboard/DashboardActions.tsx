          ...
          <div className="group flex items-center justify-between bg-white border border-border/50 hover:border-[#8B5CF6]/30 p-5 rounded-2xl shadow-sm transition-all hover:shadow-md cursor-pointer h-full">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5 leading-tight">Agende um compromisso importante no seu calendário.</p>
              </div>
            </div>
            <div className="flex items-center gap-3 pl-2">
              <ArrowRight className="w-5 h-5 text-muted-foreground/30 group-hover:text-[#8B5CF6] transition-colors opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0" />
        ...
        <Link href="/relatorios">
          <div className="group flex items-center justify-between bg-white border border-border/50 hover:border-[#8B5CF6]/30 p-5 rounded-2xl shadow-sm transition-all hover:shadow-md cursor-pointer h-full">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-medium text-foreground group-hover:text-[#8B5CF6] transition-colors">Relatórios</h3>
                <p className="text-sm text-muted-foreground mt-0.5 leading-tight">Acesse as análises detalhadas do seu desempenho.</p>
              </div>
            </div>
            <div className="flex items-center gap-3 pl-2">
              <ArrowRight className="w-5 h-5 text-muted-foreground/30 group-hover:text-[#8B5CF6] transition-colors opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0" />
          ...
          <div className="group flex items-center justify-between bg-white border border-border/50 hover:border-[#8B5CF6]/30 p-5 rounded-2xl shadow-sm transition-all hover:shadow-md cursor-pointer h-full">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5 leading-tight">Interaja com a inteligência artificial para insights rápidos.</p>
              </div>
            </div>
            <div className="flex items-center gap-3 pl-2">
              <ArrowRight className="w-5 h-5 text-muted-foreground/30 group-hover:text-[#8B5CF6] transition-colors opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0" />
