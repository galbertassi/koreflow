const fs = require('fs');
let code = fs.readFileSync('src/app/(dashboard)/configuracoes/page.tsx', 'utf8');
...
fs.writeFileSync('src/app/(dashboard)/configuracoes/page.tsx', replacement, 'utf8');
console.log('Settings page updated to use local state correctly');
